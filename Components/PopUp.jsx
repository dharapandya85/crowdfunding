...
const [allDonations,setallDonationData]=useState();
        ...
        bg-white outline-none focus:outline-none">
          ...
          border-slate-200 rounded-t">
           ...
           {/* /* <input
            ...
            bg-white border-gray-300 rounded shadow-sm appearance-none
          ...
          border-slate-200 rounded-b">
            ...
            uppercase text-sm px-6 rounded shadow hover:shadow-lg outline-none
