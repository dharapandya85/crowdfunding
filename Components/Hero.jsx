    ...
    <div className="relative">
      ...
      md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
        <div className="flex flex-col items-center  justify-between xl:flex-row">
          <div className="w-full max-w-wl mb-12 xl:mb-0 xl:pr-16  xl:w-7/12">
          ...
          <p className="max-w-xl mb-4 text-base text-gray text-gray-200 md:text-lg">
            Sed ut perspiciatis unde omnis iste natus error sit volumptatem
          ...
          <div className="bg-white rounded shadow-2xl p-7 sm:p-10">
            ...
            <form>
              ...
              <div className="mb-1 sm:mb-2">
                <label
                htmlFor="lastName"
                className="inline-border mb-1 font-medium"
                >
                Description
                </label>
              <input 
